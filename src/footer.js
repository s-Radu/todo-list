import { createDrawer } from "./footerDrawer";
...
export default function footer() {
  ...
  let drawerContents = {
    navAbout: aboutContent,
    navPrivacy: privacyContent,
    navLicencing: licencingContent,
    navContact: contactContent,
  };

  let drawer = createDrawer(drawerContents["navAbout"]);
...
<span id="drawer-right-label"
                ...
                <p class="text-2xl text-gray-700 dark:text-gray-300">Software License Agreement</p>
            </span>
            <button type="button" data-drawer-hide="drawer-right-example" aria-controls="drawer-right-example"
                class="text-gray-400 bg-transparent hover:bg-gray-200            hover:text-gray-900 rounded-lg text-sm w-8 h-8 absolute top-2.5 end-2.5 inline-flex items-center justify-center dark:hover:bg-gray-600 dark:hover:text-white">
                <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
...
<span id="drawer-right-label"
                ...
                <p class="text-2xl text-gray-700 dark:text-gray-300">Contact us</p>
            </span>
            <button type="button" data-drawer-hide="drawer-right-example" aria-controls="drawer-right-example"
                class="text-gray-400 bg-transparent hover:bg-gray-200            hover:text-gray-900 rounded-lg text-sm w-8 h-8 absolute top-2.5 end-2.5 inline-flex items-center justify-center dark:hover:bg-gray-600 dark:hover:text-white">
                <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
