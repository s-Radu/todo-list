...
/* harmony export */   setupSubscriptions: () => (/* binding */ setupSubscriptions)
/* harmony export */ });
...
function home() {
  ...
  home.className =
    "relative container mx-auto rounded-2xl m-4 flex flex-wrap justify-center";
  home.id = "homePage";
  home.innerHTML = `
...
(function () {
  ...
  (0,_home__WEBPACK_IMPORTED_MODULE_8__.setupSubscriptions)();
