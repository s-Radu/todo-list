...
function nav() {
  ...
  <div class="flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                <div class="flex justify-between items-center w-32 md:mr-4" data-newProject data-modal-target="crud-modal" data-modal-toggle="crud-modal" >
...
function newProjectModal() {
  ...
  modal.innerHTML = `
    <div class="absolute left-2/4 top-2/4 -translate-x-2/4 -translate-y-2/4 p-4 w-full max-w-md max-h-full">
