...
document.addEventListener("DOMContentLoaded", () => {
  activeTasks.forEach((task) => {
    ...
    const str = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__.format)(task.date, "EEEE, d MMMM yyyy");
    addNewTaskCardToDOM(
      task.name,
      task.description,
      str,
