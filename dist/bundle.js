...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ activeProjects)
/* harmony export */ });
function activeProjects() {
  ...
  <h1 class="text-center text-4xl m-4 text-gray-500 dark:text-white">Active Projects</h1>
    ...
    <div data-activeProjectsPage class="flex flex-wrap justify-center items-start gap-4 p-5 overflow-y-auto scrollbar-hide w-full"></div>
  `;
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ completedProjects)
/* harmony export */ });
function completedProjects() {
  ...
  <h1 class="text-center text-4xl m-4 text-gray-500 dark:text-white">Completed Projects</h1>
   ...
   <div data-completedProjectsPage class="flex flex-wrap justify-center items-start gap-4 p-5 overflow-y-auto scrollbar-hide w-full"></div>
  `;
...
function toggleDarkMode() {
  ...
  const toggle = (0,_utilis__WEBPACK_IMPORTED_MODULE_0__.getElement)("#toggle");
...
_utilis_js__WEBPACK_IMPORTED_MODULE_2__["default"].subscribe("projectsUpdated", (newProjectsCount) => {
  const projectsCountElement = (0,_utilis_js__WEBPACK_IMPORTED_MODULE_2__.getElement)("#projectsCount");
...
/* harmony export */ });
/* harmony import */ var _utilis__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./utilis.js */ "./src/utilis.js");
...
function removeNewProject(e) {
  ...
  let userResponse = confirm(
    `${_drawer__WEBPACK_IMPORTED_MODULE_1__.userName}, are you sure you want to delete this project?`
  );
  if (userResponse) {
    ...
    _utilis__WEBPACK_IMPORTED_MODULE_0__["default"].publish("projectsUpdated", projects.length);
...
function insertNewElement(newElement) {
  const parentUl = (0,_utilis__WEBPACK_IMPORTED_MODULE_0__.getElement)(DROPDOWN_SELECTOR);
...
document.addEventListener("DOMContentLoaded", () => {
  projects.forEach((project) => {
    ...
    const str = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__.format)(project.date, "EEEE, d MMMM yyyy");
    addNewProjectToDOM(
      project.name,
      project.description,
      str,
...
function getFormData(e) {
  ...
  if (name === "" || date === "" || category === "") {
    ...
    const str = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__.format)(date, "EEEE, d MMMM yyyy");
...
function addNewProjectToDOM(name, description, date, category, id) {
  ...
  pages.forEach((page) => {
    ...
    const pageElement = (0,_utilis__WEBPACK_IMPORTED_MODULE_0__.getElement)(`[data-${page}]`);
...
(function () {
  ...
  parentElement.appendChild((0,_allProjects__WEBPACK_IMPORTED_MODULE_9__["default"])());
  parentElement.appendChild((0,_activeProjects__WEBPACK_IMPORTED_MODULE_10__["default"])());
  parentElement.appendChild((0,_completedProjects__WEBPACK_IMPORTED_MODULE_11__["default"])());
  parentElement.appendChild((0,_notes__WEBPACK_IMPORTED_MODULE_12__["default"])());
  parentElement.appendChild((0,_newProjectModal__WEBPACK_IMPORTED_MODULE_7__["default"])());
  parentElement.appendChild((0,_footer__WEBPACK_IMPORTED_MODULE_13__["default"])());
  ...
  const callback = function (mutationsList, observer) {
    for (let mutation of mutationsList) {
      if (mutation.type === "childList") {
        ...
        if (submitButton) {
          submitButton.addEventListener("click", _newProjects__WEBPACK_IMPORTED_MODULE_4__.getFormData);
