...
function drawer() {
  const drawer = (0,_utilis__WEBPACK_IMPORTED_MODULE_0__.createElement)({
    tag: "div",
...
_utilis__WEBPACK_IMPORTED_MODULE_0__["default"].subscribe("notes", updateNotesCount);
...
function updateNotesCount(taskCount) {
  const notesCountElement = (0,_utilis__WEBPACK_IMPORTED_MODULE_0__.getElement)("#notesCount");
  if (notesCountElement) {
    notesCountElement.textContent = taskCount;
  }
}
...
function footer() {
  let footer = (0,_utilis_js__WEBPACK_IMPORTED_MODULE_0__.createElement)({
    tag: "footer",
    id: "footer",
...
function createDrawer(title, content) {
  const drawer = (0,_utilis_js__WEBPACK_IMPORTED_MODULE_0__.createElement)({
    tag: "div",
...
function nav() {
  let navEle = (0,_utilis_js__WEBPACK_IMPORTED_MODULE_0__.createElement)({
    tag: "nav",
    classes:
...
function newTaskModal() {
  let modal = (0,_utilis_js__WEBPACK_IMPORTED_MODULE_0__.createElement)({
    tag: "div",
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   capitulizeFirstLetter: () => (/* binding */ capitulizeFirstLetter),
...
function createForm() {
  const form = (0,_utilis_js__WEBPACK_IMPORTED_MODULE_0__.createElement)({
    tag: "form",
    classes:
...
function addNewNote(e) {
  e.preventDefault();
  const parentElement = (0,_utilis_js__WEBPACK_IMPORTED_MODULE_0__.getElement)("#allNotes");
  const form = e.target.closest("form");
  const title = (0,_newTasks_js__WEBPACK_IMPORTED_MODULE_1__.capitulizeFirstLetter)(form.querySelector("input").value);
  const content = (0,_newTasks_js__WEBPACK_IMPORTED_MODULE_1__.capitulizeFirstLetter)(form.querySelector("textarea").value);
...
function deleteNote(e, id) {
  ...
  let askForConfirmation = confirm(
    `${_drawer_js__WEBPACK_IMPORTED_MODULE_2__.userName} are you sure you want to delete this note?`
  );
...
function createNewNote({ title, content, date, id }) {
  let note = (0,_utilis_js__WEBPACK_IMPORTED_MODULE_0__.createElement)({
    tag: "div",
    id: id,
...
function todaysDate() {
  const now = new Date();
  const str = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__.format)(now, "EEEE, d MMMM yyyy HH:mm:ss");
...
function updatePubSub() {
  _utilis_js__WEBPACK_IMPORTED_MODULE_0__["default"].publish("notes", activeNotes.length);
}
...
/* harmony import */ var _utilis__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./utilis */ "./src/utilis.js");
...
/* harmony import */ var _homePage_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./homePage.js */ "./src/homePage.js");
/* harmony import */ var _activeTasksPage_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./activeTasksPage.js */ "./src/activeTasksPage.js");
/* harmony import */ var _completedTasksPage_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./completedTasksPage.js */ "./src/completedTasksPage.js");
/* harmony import */ var _notesPage_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./notesPage.js */ "./src/notesPage.js");
...
(function () {
  ...
  const pagesElements = [
    _nav__WEBPACK_IMPORTED_MODULE_6__["default"],
    _drawer__WEBPACK_IMPORTED_MODULE_5__["default"],
    _homePage_js__WEBPACK_IMPORTED_MODULE_8__["default"],
    _activeTasksPage_js__WEBPACK_IMPORTED_MODULE_9__["default"],
    _completedTasksPage_js__WEBPACK_IMPORTED_MODULE_10__["default"],
    _notesPage_js__WEBPACK_IMPORTED_MODULE_11__["default"],
    _newTaskModal__WEBPACK_IMPORTED_MODULE_7__["default"],
    _footer__WEBPACK_IMPORTED_MODULE_12__["default"],
  ];
  pagesElements.forEach((element) => parentElement.appendChild(element()));

  //> DOM elements
  let darkModeToggle = (0,_utilis__WEBPACK_IMPORTED_MODULE_2__.getElement)("#toggle");

  let ids = ["mainHome", "home", "active", "completed", "notes"];

  //> Event listeners
  darkModeToggle.addEventListener("click", _darkMode__WEBPACK_IMPORTED_MODULE_3__.toggleDarkMode);
  ...
  ids.forEach((id) => {
    (0,_utilis__WEBPACK_IMPORTED_MODULE_2__.getElement)(`#${id}`).addEventListener("click", (e) => {
      const pages = ["homePage", "activePage", "completedPage", "notesPage"];

      pages.forEach((page) => {
        if (id === "mainHome" && page === "homePage") {
          (0,_utilis__WEBPACK_IMPORTED_MODULE_2__.getElement)(`#${page}`).classList.remove("hidden");
        } else if (page === `${id}Page`) {
          (0,_utilis__WEBPACK_IMPORTED_MODULE_2__.getElement)(`#${page}`).classList.remove("hidden");
        } else {
          (0,_utilis__WEBPACK_IMPORTED_MODULE_2__.getElement)(`#${page}`).classList.add("hidden");
        }
      });
    });
  });
  ...
  const callback = function (mutationsList, observer) {
    for (let mutation of mutationsList) {
      if (mutation.type === "childList") {
        const submitButton = (0,_utilis__WEBPACK_IMPORTED_MODULE_2__.getElement)("[data-submit");
        if (submitButton) {
