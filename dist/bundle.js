...
<img src="${_imgs_arrowLeft_png__WEBPACK_IMPORTED_MODULE_0__["default"]}" alt="arrow left" class="absolute hidden md:block left-10 -top-40 w-44 h-44 cursor-pointer">
<img src="${_imgs_arrowRight_png__WEBPACK_IMPORTED_MODULE_1__["default"]}" alt="arrow right" class="absolute hidden md:block right-28 -top-40 w-44 h-44 cursor-pointer">
`;
...
function getFormData(e) {
  ...
  if (name === "" || date === "" || category === "") {
    ...
    const homePage = (0,_utilis__WEBPACK_IMPORTED_MODULE_0__.getElement)("#homePage");
